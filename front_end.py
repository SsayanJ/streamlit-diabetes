...
if config_button:
    res = requests.get('http://127.0.0.1:8000/model_config')
...
if submit_button:
    ...
    res = requests.post('http://127.0.0.1:8000/predict', data=json.dumps(m))
...
if st.button('Predict Diabete evolution'):
    if csv_file:
        ...
        predictions = requests.post('http://127.0.0.1:8000/predict_obj', data=diabetes_data_json)
        st.write(
